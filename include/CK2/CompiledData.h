...
public:
    CompiledTextData() { PrepareStructure(); }
    ~CompiledTextData() { ClearStructure(); }
    ...
    void ClearStructure() {
        delete[] (CKBYTE *) m_DrawPrimData.PositionPtr;
        delete[] (CKBYTE *) m_DrawPrimData.NormalPtr;
        delete[] (CKBYTE *) m_DrawPrimData.ColorPtr;
        delete[] (CKBYTE *) m_DrawPrimData.SpecularColorPtr;
        delete[] (CKBYTE *) m_DrawPrimData.TexCoordPtr;
        for (int i = 0; i < CKRST_MAX_STAGES - 1; ++i) {
            delete[] (CKBYTE *) m_DrawPrimData.TexCoordPtrs[i];
        }
    }
