#ifndef BALLOON_VARIANT_H
#define BALLOON_VARIANT_H
...
#define VAR_SUBTYPE_FALSE    ((uint8_t)(0 << 3)) /* _0000___ */
#define VAR_SUBTYPE_TRUE     ((uint8_t)(1 << 3)) /* _0001___ */
...
#define VAR_TAG_BIT          ((uint8_t)8)
    ...
    public:
        ...
        Variant &operator=(bool value) {
            ...
            SetType(VAR_TYPE_BOOL, value ? VAR_SUBTYPE_TRUE : VAR_SUBTYPE_FALSE);
            return *this;
        }
        ...
        bool GetBool() const {
            return GetTag() == (VAR_TYPE_BOOL | VAR_SUBTYPE_TRUE);
        }
